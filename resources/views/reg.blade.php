                ...
                <div class="container">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="item">
                        <img src="{{ asset('images/sapiens (6) 1.png') }}" alt="New york" style="width:500px; height: 500px;">
                          <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="item">
                        <img src="{{ asset('images/sapiens (7) 1.png') }}" alt="New york" style="width:500px; height: 500px;">
                          <div class="carousel-caption d-none d-md-block">
                            <h3>Это мой город</h3>
                          </div>
                        </div>
                        ...
                        <div class="item">
                        <img src="{{ asset('images/sapiens (8) 1.png') }}" alt="New york" style="width:500px; height: 500px;">
                          <div class="carousel-caption d-none d-md-block">
                            <h3>Улучшим город вместе</h3>
                          </div>
                        </div>
                        ...
                        <div class="item">
                        <img src="{{ asset('images/sapiens (9) 1.png') }}" alt="New york" style="width:500px; height: 500px;">
                          <div class="carousel-caption d-none d-md-block">
              ...
              <div class="card-body py-5 px-md-5">
                ...
                <form>
                  ...
                  <div class="d-grid gap-2">
                    <button class="btn btn-secondary btn-lg btn-block" style="background-color: #3300FF;" type="button">Registration</button>
                    <button class="btn btn-secondary btn-lg btn-block" type="button" onclick="document.location='login'">Log in</button>
